...
import {
  ...
  'react-native';
import { createAppContainer, NavigationEvents } from '@react-navigation/native';
...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch('https://marketudbguia11dps.000webhostapp.com/apiusuario.php?comando=autenticar&usuario=' + this.state.usuario + ' & contrasena=' + this.state.contrasena, {
        method: 'GET'
      })
...
class listarProductos extends React.Component {
  ...
  cargarRegistros() {
    console.log('Prueba');
    fetch('https://marketudbguia11dps.000webhostapp.com/api.php?comando=listar', {
      method: 'GET'
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaDetalle extends React.Component {
  ...
  Actualizar() {
    fetch('https://marketudbguia11dps.000webhostapp.com/api.php?comando=editar&nombre=' + this.state.nombre
      + '&descripcion=' + this.state.descripcion
      + '&cantidad=' + this.state.cantidad
      + '&precioCosto=' + this.state.preciodecosto
      + '&precioVenta=' + this.state.preciodeventa
  ...
  Eliminar() {
    fetch('https://marketudbguia11dps.000webhostapp.com/api.php?comando=eliminar&id=' + this.state.id, {
      method: 'GET'
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaAgregar extends React.Component {
  ...
  Guardar() {
    fetch('https://marketudbguia11dps.000webhostapp.com/api.php?comando=agregar&nombre=' +
      this.state.nombre
      + '&descripcion=' + this.state.descripcion
      + '&cantidad=' + this.state.cantidad
      + '&precioCosto=' + this.state.preciodecosto
